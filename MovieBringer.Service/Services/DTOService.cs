...
{
    public class DTOService<Entity, Dto> : IDTOService<Entity, Dto> where Entity : BaseEntity where Dto : class
    {
        protected readonly IUnitOfWork _unitOfWork;
        protected readonly IMapper _mapper;
        private readonly IGenericRepository<Entity> _repository;

        public DTOService(IMapper mapper, IUnitOfWork unitOfWork, IGenericRepository<Entity> repository)
        {
            _mapper = mapper;
